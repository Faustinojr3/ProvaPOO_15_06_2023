...
informados pelo usuário.*/
    ...
    internal class Funcionario
    {
        ...
        protected DateOnly data_nascimento;
        protected string sexo;
        protected double salario;

        public Funcionario(string nome, string cpf , int matricula, DateOnly data_nascimento, string sexo, double salario ) {
        ...
        public Funcionario(string nome, string cpf, int matricula, DateOnly data_nascimento, string sexo, double salario, double valor_hora_ext)
        {
